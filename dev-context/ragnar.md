...
source: "https://ragnar.tidyverse.org"
language: "en"
...
- `ragnar_retrieve_vss()`: Retrieve using [`vss` DuckDB extension](https://duckdb.org/docs/stable/core_extensions/vss)
- `ragnar_retrieve_bm25()`: Retrieve using [`full-text search DuckDB extension`](https://duckdb.org/docs/stable/core_extensions/full_text_search)
...
Here’s an example of using ragnar to create a knowledge store from the *R for Data Science (2e)* book:
